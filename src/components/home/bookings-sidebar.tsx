...
export function BookingsSidebar({ visible = false, onToggle, variant = 'default' }: BookingsSidebarProps) {
  ...
  const getSidebarVariantStyles = () => {
    switch (variant) {
      case 'modern':
        return {
          sidebarClass: "fixed top-0 left-0 h-full w-full sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/4 bg-slate-800/95 backdrop-blur-xl border-r border-slate-600/50 z-50 transition-all duration-500 ease-in-out",
          headerClass: "flex items-center justify-between mb-4",
          titleClass: "text-lg sm:text-xl font-semibold text-white",
          monthNavClass: "mb-4",
          monthContainerClass: "flex items-center justify-between bg-slate-700/50 rounded-xl p-2 sm:p-3 border border-slate-600/50",
          monthButtonClass: "p-1.5 sm:p-2 rounded-lg hover:bg-slate-600/50 transition-colors text-slate-300 hover:text-white",
          monthTitleClass: "text-base sm:text-lg font-semibold text-white",
          monthSubtitleClass: "text-[10px] sm:text-xs text-slate-400",
          searchClass: "mb-4",
          searchInputClass: "w-full pl-9 pr-3 py-2 sm:pl-10 sm:pr-4 sm:py-3 bg-slate-700/50 border border-slate-600/50 rounded-xl text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50",
          searchIconClass: "absolute left-2.5 sm:left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-slate-400",
          clearButtonClass: "absolute right-2.5 sm:right-3 top-1/2 transform -translate-y-1/2 text-slate-400 hover:text-white transition-colors",
          bookingsListClass: "flex-1 overflow-y-auto space-y-2 sm:space-y-3 sidebar-scroll",
          dateHeaderClass: "sticky top-0 bg-slate-800/95 backdrop-blur-sm border-b border-slate-600/50 pb-2",
          dateTitleClass: "text-base sm:text-lg font-semibold text-white/90",
          dateSubtitleClass: "text-[10px] sm:text-xs text-slate-400",
          cardClass: "bg-slate-700/50",
          cardContentClass: "p-1 sm:p-1.5",
          buttonClass: "text-slate-300 hover:text-white hover:bg-slate-600/50 text-sm",
          refreshButtonClass: "text-slate-300 hover:text-white hover:bg-slate-600/50 text-sm",
          footerClass: "mt-4 pt-4 border-t border-slate-600/50",
          footerTextClass: "text-slate-400 text-[11px] sm:text-xs text-center"
        }
      case 'minimal':
        return {
          sidebarClass: "fixed top-0 left-0 h-full w-full sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/4 bg-white/95 backdrop-blur-xl border-r border-gray-200 z-50 transition-all duration-500 ease-in-out",
          headerClass: "flex items-center justify-between mb-4",
          titleClass: "text-lg sm:text-xl font-semibold text-gray-900",
          monthNavClass: "mb-4",
          monthContainerClass: "flex items-center justify-between bg-gray-50 rounded-lg p-2 sm:p-3 border border-gray-200",
          monthButtonClass: "p-1 rounded hover:bg-gray-100 transition-colors text-gray-500 hover:text-gray-700",
          monthTitleClass: "text-base sm:text-lg font-semibold text-gray-900",
          monthSubtitleClass: "text-[10px] sm:text-xs text-gray-500",
          searchClass: "mb-4",
          searchInputClass: "w-full pl-9 pr-3 py-2 sm:pl-10 sm:pr-4 bg-gray-50 border border-gray-200 rounded-lg text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:border-gray-400",
          searchIconClass: "absolute left-2.5 sm:left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400",
          clearButtonClass: "absolute right-2.5 sm:right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors",
          bookingsListClass: "flex-1 overflow-y-auto space-y-2 sm:space-y-3 sidebar-scroll",
          dateHeaderClass: "sticky top-0 bg-white/95 backdrop-blur-sm border-b border-gray-200 pb-2",
          dateTitleClass: "text-base sm:text-lg font-semibold text-gray-900",
          dateSubtitleClass: "text-[10px] sm:text-xs text-gray-500",
          cardClass: "bg-gray-50",
          cardContentClass: "p-1 sm:p-1.5",
          buttonClass: "text-gray-500 hover:text-gray-700 hover:bg-gray-100 text-sm",
          refreshButtonClass: "text-gray-500 hover:text-gray-700 hover:bg-gray-100 text-sm",
          footerClass: "mt-4 pt-4 border-t border-gray-200",
          footerTextClass: "text-gray-500 text-[11px] sm:text-xs text-center"
        }
      default:
        return {
          sidebarClass: "fixed top-0 left-0 h-full w-full sm:w-2/3 md:w-1/2 lg:w-1/3 xl:w-1/4 backdrop-blur-xl border-r border-gray-200 z-50 transition-all duration-500 ease-in-out",
          headerClass: "flex items-center justify-between mb-4",
          titleClass: "text-lg sm:text-xl font-semibold",
          monthNavClass: "mb-4",
          monthContainerClass: "flex items-center justify-between rounded-lg p-2 sm:p-3 border border-gray-200",
          monthButtonClass: "p-1 rounded hover:bg-gray-100 transition-colors hover:text-gray-700",
          monthTitleClass: "text-base sm:text-lg font-semibold",
          monthSubtitleClass: "text-[10px] sm:text-xs text-gray-500",
          searchClass: "mb-4",
          searchInputClass: "w-full pl-9 pr-3 py-2 sm:pl-10 sm:pr-4 border border-gray-200 rounded-lg placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50",
          searchIconClass: "absolute left-2.5 sm:left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400",
          clearButtonClass: "absolute right-2.5 sm:right-3 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-gray-600 transition-colors",
          bookingsListClass: "flex-1 overflow-y-auto space-y-2 sm:space-y-3 sidebar-scroll",
          dateHeaderClass: "sticky top-0 backdrop-blur-sm border-b border-gray-200 pb-2",
          dateTitleClass: "text-base sm:text-lg font-semibold",
          dateSubtitleClass: "text-[10px] sm:text-xs text-gray-500",
