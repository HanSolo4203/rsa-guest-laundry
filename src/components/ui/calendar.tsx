  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_row: "flex",
        head_cell:
          "text-muted-foreground rounded-md w-10 h-8 font-normal text-[0.8rem] flex items-center justify-center",
        row: "flex w-full",
        ...
        day: cn(
          ...
          "h-10 w-10 p-0 font-normal aria-selected:opacity-100 flex items-center justify-center rounded-md"
        ),
